...
- [x] Reemplazar el campo `barrio` por `celular` en el modelo, el formulario y el PDF; reducir los campos obligatorios a nombre y celular (petición del cliente, ver `DOCS/004-formulario-cuenta-de-cobro-errores-implementacion.md`).
