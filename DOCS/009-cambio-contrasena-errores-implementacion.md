...
**Pendiente:** el usuario del proyecto puede validar el flujo completo contra MongoDB Atlas cuando lo considere oportuno (iniciar sesión con su usuario real, ir a `/perfil`, cambiar la contraseña y confirmar que el nuevo valor funciona), igual que hizo con el login en la feature 001.
